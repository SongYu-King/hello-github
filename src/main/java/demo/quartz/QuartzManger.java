...
/**
 * ClassName：QuartzManger
 * 类描述：   定时 处理 管理
 * 操作人：wangshuang
 * 操作时间：2015-5-26 下午04:22:59
 *
 * @version 1.0
 */
public class QuartzManger {
    private static SchedulerFactory gSchedulerFactory = new StdSchedulerFactory();
    private static String JOB_GROUP_NAME = "data_handler_jobgroup_name";
    private static String TRIGGER_GROUP_NAME = "data_handler_triggergroup_name";

    private static QuartzManger instance = new QuartzManger();

    private QuartzManger() {
    }

    public static QuartzManger getInstance() {
        return instance;
    }
