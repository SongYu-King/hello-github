...
//		        String data = "20AE1E00C40141CAABFED878C667B5828C5FB24ED38FDAFC"; 
//		        System.out.println(data);
//		        byte[] digest = hex2byte(data);
//
//		       byte[] num= ByteOprs.subBuff(digest, 0, 4);
//
//		        String test1 = "1";
//		        System.out.println(test1);
//		     byte[] now =  ByteOprs.addBuff(num, new SHA1().getDigestOfBytes(ByteOprs.addBuff(num,test1.getBytes())));
//		        System.out.println(byteArrayToHexString(now));
        ...
        byte[] digest = hex2byte(data);
       byte[] b0= new byte[4];
       System.arraycopy(digest, 0, b0, 0, 4);
        String passwd = "1";
        byte[] b1 = new SHA1().getDigestOfBytes(passwd.getBytes("UTF-8"));
        byte[] temp = new byte[4+b1.length];        
        System.arraycopy(b0, 0, temp, 0, 4);
        System.arraycopy(b1, 0, temp, 4, b1.length);       
     byte[] b2 =   new SHA1().getDigestOfBytes(temp);
     byte[] b3 = new byte[24];
        System.arraycopy(b0, 0, b3, 0, 4);
        System.arraycopy(b2, 0, b3, 4, 20);
        System.out.println(byteArrayToHexString(b3));
